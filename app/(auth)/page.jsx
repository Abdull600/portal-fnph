...
export default function Auth() {
    ...
    const handleClick = () => {
        alert("Login successful... to Dashboad");
        ...
        <div className="flex flex-col gap-2 flex-start items-center justify-center pt-[10px] w-full mx-10 md:mx-0 md:w-0">
            <div className="bg-[#fff] w-full md:w-[488px] md:h-[335px] rounded-[15px] border-[1.5px] border-[#D0D5DD] px-5 py-5">
                <form>
                    ...
                    {/* password */}
                    <div className="w-full mx-auto py-1">
                        <label htmlFor="email-address-icon" className="block mb-2 text-sm md:text-[14px] font-medium text-[#101928] capitalize">password</label>
                        <div className="relative">
                            <div className="absolute inset-y-0 end-0 flex items-center pe-3.5 pointer-events-none">
                                <FiEyeOff
                                    className="w-4 h-4 text-gray-500 dark:text-gray-400"
                    ...
                    <div className="w-full mx-auto py-1">
                        <div className="flex items-center justify-center">
                            <div className="ms-2 text-[14px] font-medium text-[#101928] leading-[20.3px]">
                                Are you a new Applicant?     <Link href="/sign-up" className="text-[#107001] text-[12px] md:text-[14px] font-bold leading-[20.3px] cursor-pointer capitalize hover:underline">Create Account</Link>.
                            </div>
                        </div>
                    </div>
                </form>
